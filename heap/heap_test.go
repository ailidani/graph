...
func TestPopAndPeekOnEmpty(t *testing.T) {
	heap := New(func(a, b int) bool { return a < b })
...
func ExampleFrom() {
	heap := From(func(a, b int) bool { return a < b }, 5, 2, 3)
...
func ExampleFromSlice() {
	heap := FromSlice(func(a, b int) bool { return a > b }, []int{-1, 5, 2, 3})
